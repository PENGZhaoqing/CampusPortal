class User < ActiveRecord::Base
  ...
  has_many :applications, class_name: 'Doorkeeper::Application', through: :relationships, source: :application
  has_one :resource, dependent:   :destroy
  mount_uploader :icon, IconUploader

  attr_accessor :remember_token,:activation_token,:reset_token
  before_save   :downcase_email
  before_create :user_create_activation_digest
  ...
  def user_send_password_reset_email
  ...
  def user_create_activation_digest
